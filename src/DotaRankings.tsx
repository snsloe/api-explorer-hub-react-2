...
interface HeroRanking extends HeroStats {
    rank: number;
    winrate: string;
}

const DotaRankings: React.FC = () => {
    const [rankings, setRankings] = useState<HeroRanking[]>([]);
    ...
    const displayHeroesRanking = (heroStats: HeroStats[], rankingType: string) => {
        ...
        const rankingsWithData: HeroRanking[] = topHeroes.map((hero, index) => ({
            ...hero,
            rank: index + 1,
                ...
                <div id="rankingsContainer" className="facts-container">
                    {rankings.length > 0 && (
                        <div className="fact-card">
                            <h3 style={{ color: '#586069', margin: '0.5rem 0 0 0', textAlign: 'center' }}>
